...
# NOTE modified from src to make it adapt to Flutter's versioning system https://github.com/fastlane/fastlane/blob/master/fastlane/lib/fastlane/actions/commit_version_bump.rb
module Fastlane
  module Actions
    module SharedValues
    ...
    class SimplifiedCommitVersionBumpAction < Action
      def self.run(params)
        ...
        UI.message("expected_changed_files=#{expected_changed_files}")
